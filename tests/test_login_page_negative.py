...
class TestNegativeScenarios:
    ...
    # parametrize bize birden çok testi nasıl daha kısa bir biçimde yazacağımızı gösteriyor
    # kodumuz kısalıyor ve iki testi birden yapabiliyoruz.
    ...
    def test_negative_username(self, driver):
        ...
        # is_displayed mesajın görünmesini sağlıyor. eğer ki hata verirse "Error message is not displayed, but it should be" bu yayınlanıyor hatada.
